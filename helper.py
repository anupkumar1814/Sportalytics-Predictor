...
def most_successful(df, sport):
    # Drop rows with NaN in the 'Medal' column
    ...
    # Count the occurrences of each athlete's name and get the top 15
    ...
    x = top_athletes.merge(df, left_on='Name', right_on='Name', how='left')[['Name', 'Medals', 'Sport', 'region']]
...
def most_successful_countrywise(df, country):
    ...
    # Count the occurrences of each athlete's name and get the top 10
    top10_names = temp_df['Name'].value_counts().reset_index().head(10)
    top10_names.columns = ['Name', 'Medals']  # Rename columns for clarity

    # Merge with the original DataFrame to get additional information
    top10_df = top10_names.merge(df, left_on='Name', right_on='Name', how='left')[
